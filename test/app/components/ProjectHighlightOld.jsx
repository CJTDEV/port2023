...
//                 <h3 className={`${projects.highlight__title} headline`} dangerouslySetInnerHTML={{ __html: props.title }}></h3>
...
//                     }
//                 </div>
//                 <p className={`${projects.highlight__copy} copy light`}>{props.copy}</p>
//                 <Button label={"Learn More"} spacing={"default"} type={"default"} />
//             </div>
