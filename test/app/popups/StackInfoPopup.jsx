...
export default function StackInfoPopup() {
	...
	return (
		<div className={`${popup.content}`}>
			...
			<div className={`${popup.legend__pill} copy-small`}>
				<span>Intermediate</span> means I have spent a minimum of one year leveraging this Technology and use it frequently for work related and private projects.
			</div>
			...
			<div className={`${popup.legend__pill} copy-small`}>
				<span>Workflow</span> means I have had an eye on the Technology and there is a high chance I have followed up on this interest by taking part in online courses.
			</div>
		</div>
	)
}